...
- [Resources signals](https://v22.angular.dev/guide/signals/resource): a new way to manage asynchronous data in Angular applications using signals.
- [Signal forms](https://v22.angular.dev/essentials/signal-forms): a new approach to building forms in Angular using signals.
- [Angular Aria](https://v22.angular.dev/guide/aria): a headless library for building accessible components in Angular.
